        ...
        function downloadReportHTML() {
            ...
            <head>
                ...
                <style>
                    ...
                    .gradient-text { background: linear-gradient(135deg, #0a74da, #061a40); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-weight: bold; }
                    .stat-box { background: linear-gradient(135deg, rgba(10, 116, 218, 0.1), rgba(6, 26, 64, 0.1)); border-radius: 10px; padding: 20px; text-align: center; border: 2px solid #0a74da; }
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="alert alert-info">
                                    <i class="bi bi-info-circle me-2"></i>The report will be sent as an HTML email to the specified address.
                                </div>
                            </div>
