...
CONFIG = {
    ...
    'USE_VIRUSTOTAL': True,
    'USE_ML_MODEL': True,  # Enable ML model for dual-layer detection (ML + VirusTotal)
    'SCAN_EXTENSIONS': [
...
class RansomwareScanner:
    ...
    def scan_file(self, filepath):
        ...
        # Now checks: (1) If ML detects threat, OR (2) If file has suspicious extension, OR (3) If executable
        vt_result = None
        threat_level = 'safe'
        ...
        should_check_vt = (
            ...
            is_executable  # Is an executable file (higher risk)
        )
