...
<html lang="en" class="remember-theme">
  <head>
    ...
    <link rel="shortcut icon" href="<?=MDIR;?>assets/media/favicons/favicon.png">
    <link rel="icon" type="image/png" sizes="192x192" href="<?=MDIR;?>assets/media/favicons/favicon-192x192.png">
    <link rel="apple-touch-icon" sizes="180x180" href="<?=MDIR;?>assets/media/favicons/apple-touch-icon-180x180.png">
    <!-- END Icons -->

    <!-- Stylesheets -->

    <!-- Codebase framework -->
    <link rel="stylesheet" id="css-main" href="<?=MDIR;?>assets/css/codebase.min.css">

    <!-- You can include a specific file from css/themes/ folder to alter the default color theme of the template. eg: -->
    <!-- <link rel="stylesheet" id="css-theme" href="<?=MDIR;?>assets/css/themes/flat.min.css"> -->
    <!-- END Stylesheets -->

    <!-- Load and set color theme + dark mode preference (blocking script to prevent flashing) -->
    <script src="<?=MDIR;?>assets/js/setTheme.js"></script>
  </head>
  ...
  <body>
          ...
          <div class="hero-inner">
            <div class="content content-full">
              <div class="py-4 text-center">
                ...
                <a class="btn btn-lg btn-alt-secondary" href="<?php echo MDIR;?>">
    ...
    <!--
        ...
        webpack is putting everything together at <?=MDIR;?>assets/_js/main/app.js
    -->
    <script src="<?=MDIR;?>assets/js/codebase.app.min.js"></script>
  </body>
</html>